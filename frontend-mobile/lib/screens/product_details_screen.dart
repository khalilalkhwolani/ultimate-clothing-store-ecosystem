                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              Text(
                                "${context.l10n.price}: \$${widget.product.price.toStringAsFixed(2)}",
                                style: TextStyle(
                                  fontSize: 16,
                                  fontWeight: FontWeight.bold,
                              ...
                              SizedBox(width: 12),
                              Text(
                                "${context.l10n.discount}: \$${(widget.product.price * 1.2).toStringAsFixed(2)}",
                                style: TextStyle(
                                  fontSize: 12,
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              _buildFeature(
                                Icons.eco,
                                context.l10n.organicCotton,
                              ),
                              _buildFeature(
                                Icons.local_laundry_service,
                                context.l10n.machineWashable,
                              ),
                              _buildFeature(
                                Icons.verified,
                                context.l10n.qualityAssured,
                              ),
                            ],
                          ),
                        ],
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                SizedBox(height: 12),
                                Text(
                                  context.l10n.sampleReviewContent,
                                  style: TextStyle(
                                    height: 1.5,
                                    color: AppTheme.textsecandery,
                                  ),
                ...
                children: [
                  ...
                  Expanded(
                    child: GradientButton(
                      ...
                      onPressed: () async {
                        try {
                          await widget._cartcontroller.addToCart(
                            widget.product,
                            quantity: 1,
